...
public class MoviesApplication {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("3. actors movies view");
            ...
            switch (answer) {
                ...
                case 3:
                    ...
                    showActorView(scanner, moviesService, actorId);
                    break;
            }
        } while(answer != 0);
    }

    private static void showActorView(Scanner scanner, MoviesService moviesService, int actorId)  {
