...
//      printing numbers as long as 0 will be given
        int value = 1;
        int maxValue = 0;
        while (value != 0) {
...
//      counting occurence of a digit in nmber
...
//        menu
    ...
    private static void whileLoopExercises(Scanner scanner) {
        //looking for numbers with divider = 15
        int number = 1;
        while(number % 15 != 0) {
        ...
        //insertinh numbers as long as 0 will be given, prints sum of given numbers
        boolean result = true;
        int sum = 0;
        while (result) {
